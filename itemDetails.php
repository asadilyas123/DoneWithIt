...
$query2 = "SELECT* from users_login where Email = '$email';";
...
<a href="browse.php" class="btn btn-info" id="browsebtn" style="font-weight:bold">Browse</a>
    <div class="header">
        ...
        <div class="card-body">
            <a href="buyNow.php?image=<?= $image ?>" class="btn btn-primary" id="buybtn">Buy Now</a>
  <script>
       ...
       Seller Name: <span class="text-info" > <?php echo $fullname  ?></span>
        </div>
        </div>
